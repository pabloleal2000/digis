...
$smtp.Credentials = New-Object System.Net.NetworkCredential("testpenetrationtemp@outlook.com", "lifelife123");
$smtp.EnableSsl = $true
$Message.From = "testpenetrationtemp@outlook.com"
$Message.To.Add("testpenetrationtemp@outlook.com")
